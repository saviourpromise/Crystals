      ...
      <div className="bg-[#0D0F11] flex flex-col gap-8 py-10">
        <div className="flex flex-col gap-[17px] mx:px-0 px-16">
          <p className="text-[#e4e4e7] mx:text-center mx:text-[26px] mx:leading-[40px] text-[50px] leading-[61.5px] font-semibold unv">
            We are a crytals trading hub
          </p>
          <p className="text-base mx:text-sm font-normal mx:text-center leading-7 text-[#AAAAB3] intt">
            Crystal Pips Hub, officially recognized by the Corporate Affairs Commission with registration number RC  7825446 has a mission to transform trading education,making it accessible and <br /> effective for all while delivering exceptional learning experiences
            "The heartbeat of Crystal Pips Hub is a profound belief: that informed trading decisions and sustained success stem from a <br /> robust educational framework and dedicated mentorship. We're driven not by the pursuit of accolades, but by a passion to ignite transformative growth in aspiring traders, propelling them <br /> toward extraordinary financial fluency."
            Our commitment to excellence:
            Our relentless pursuit of excellence drives us to innovate, adapt, and evolve with the dynamic trading landscape. We're <br /> not just meeting the highest standards - we're setting them. Join us in our mission to revolutionize financial education and unlock unprecedented trading potential."
            Navigating the Financial <br /> Markets:
            In the vast and intricate ocean of finance, we serve
            as your expert guide, providing the essential tools,
            knowledge, and expertise to empower confident navigation. Our dedication <br /> goes beyond education,
            cultivating a supportive community where
            individuals can flourish, share knowledge, and
            achieve success together.
            Transformative Learning at Crystal Pips Hub: <b></b>
            Where Trading Meets Personal Growth
            Our holistic approach extends beyond technical
            expertise, fostering a comprehensive learning
            experience that cultivates well-rounded, resilient traders. <br /> We nurture a deep understanding of
            market complexities, while developing the mental
            agility and emotional intelligence crucial for
            sustained success.
            Crystal Pips Hub is more than an <br /> educational institution - it's a vibrant community where likeminded individuals share knowledge, insights, and strategies. Our collaborative environment sparks growth, camaraderie, and <br /> collective evolution.
            Join us on a transformative journey that redefines your understanding of trading and empowers you with the skills, mindset, and support network necessary for enduring <br /> success.
          </p>
        </div>
